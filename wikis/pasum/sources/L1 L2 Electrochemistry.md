...
> Content reconstructed from direct visual processing of all 82 slide images.
...
Zinc has a negative electrode potential but can produce a positive cell potential:
$$E_{cell} = E°_{cathode} - E°_{anode} = 0\text{ V} - (-0.76\text{ V}) = +0.76\text{ V}$$
...
4. Calculate $E°_{cell} = E°_{cathode} - E°_{anode}$

### Example 2: Cell Potential Calculation
Given $E°_{\text{Mg}^{2+}/\text{Mg}} = -2.37$ V and $E°_{\text{Ca}^{2+}/\text{Ca}} = -2.76$ V:
