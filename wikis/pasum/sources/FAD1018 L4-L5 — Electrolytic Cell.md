---
title: "FAD1018 L4-L5 — Electrolytic Cell"
date: 2026-04-30
tags:
  - source/lecture
  - subject/chemistry
...
> Content reconstructed from direct visual processing of all 50 slide images.
...
**Cations** (discharged at cathode): ease of discharge increases down the series
$$\text{K}^+ < \text{Na}^+ < \text{Ca}^{2+} < \text{Mg}^{2+} < \text{Al}^{3+} < \text{Zn}^{2+} < \text{Fe}^{2+} < \text{Sn}^{2+} < \text{Pb}^{2+} < \text{H}^+ < \text{Cu}^{2+} < \text{Ag}^+$$

**Anions** (discharged at anode): ease of discharge increases down the series
$$\text{F}^- < \text{SO}_4^{2-} < \text{NO}_3^- < \text{Cl}^- < \text{Br}^- < \text{I}^- < \text{OH}^-$$
...
- [[L1 L2 Electrochemistry]] — electrochemical cell fundamentals
- [[Electrochemistry Part 2]] — Nernst equation, equilibrium
